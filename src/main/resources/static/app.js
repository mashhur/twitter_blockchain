$(document).ready(function () {
    ...
    var words = ["Word Cloud", "Live", "Tweets", "From", "Cities/Countries", "Streaming", "Every 5 Secs", "Word Cloud", "Live", "Tweets", "From", "Cities/Countries", "Streaming", "Every 5 Secs"];
    ...
    try {
        var socket = new SockJS('/twitter-websocket');
    ...
    function onConnected() {
        ...
        stompClient.send("/app/server.start",
            {},
    ...
    function showNewWords(vis) {
        ...
        if (browserNotSupported) {
            words = ["Internet Explorer", "Does not Support EventSource", "Please use Chrome!", "Please use Chrome!", "IE Support coming up", "in WebSocket version"];
